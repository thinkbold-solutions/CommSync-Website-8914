      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <AnimatedSection animation="fade-up">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-primary font-bold mb-6 sm:mb-8">
          ...
          <AnimatedSection animation="fade-up" delay={800}>
            <div className="mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-primary-red mb-2">
                  <AnimatedCounter end={500} suffix="+" />
                </div>
                <div className="text-gray-400 text-sm sm:text-base">Professionals Trained</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-primary-blue mb-2">
